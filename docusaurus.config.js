...
module.exports = {
  ...
  tagline: '',
  url: 'https://caci-milmove.github.io',
  baseUrl: '/mymove-docs/',
  onBrokenLinks: 'throw',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/caci-milmove/mymove',
          label: 'mymove',
          position: 'right',
        },
      ],
          ...
          items: [
            {
              ...
              href: 'https://github.com/caci-milmove/mymove-docs',
            },
            {
  ...
  presets: [
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/caci-milmove/mymove-docs/edit/main/',
    ...
    [
      'redocusaurus',
      {
        specs: [
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/admin.yaml',
            route: '/api/admin',
          },
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/internal.yaml',
            route: '/api/internal',
          },
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/ghc.yaml',
            route: '/api/ghc',
          },
          ...
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/prime.yaml',
            route: '/api/prime',
          },
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/prime.yaml',
          ...
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/prime_v2.yaml',
            route: '/api/prime/v2',
          },
          {
            spec: 'https://raw.githubusercontent.com/caci-milmove/mymove/main/swagger/support.yaml',
            route: '/api/support',
          },
        ],
      },
