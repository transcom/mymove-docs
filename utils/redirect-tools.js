module.exports = [
  {
    ...
    from: ["/docs/dev/versioning/Dependency-Update-Process-With-Dependabot"],
  },
  {
  ...
  },
  {
    ...
    from: ["/docs/dev/tools/docusaurus"],
  },
  {
    to: "/docs/tools/docusaurus/redocusaurus",
    from: ["/docs/dev/tools/redocusaurus"],
  },
  {
    to: "/docs/tools/mockery/generate-mocks-with-mockery",
    from: ["/docs/dev/testing/writing-tests/generate-mocks-with-mockery"],
  },
  {
    to: "/docs/tools/postman/setting-up-postman",
    from: ["/docs/dev/tools/Postman/Setting-Up-Postman"],
  },
  {
    to: "/docs/tools/postman/creating-a-local-environment-for-postman",
    from: ["/docs/dev/tools/Postman/Creating-A-Local-Environment-for-Postman"],
  },
  {
    to: "/docs/tools/postman/intercepting-cookies-for-postman",
    from: ["/docs/dev/tools/Postman/Intercepting-Cookies-for-Postman"],
  },
  {
  ...
  },
  {
    ...
    from: ["/docs/dev/tools/SchemaSpy"],
  },
  {
    to: "/docs/tools/telemetry/running-telemetry-locally",
    from: ["/docs/dev/tools/telemetry/Running-telemetry-locally"],
  },
];
