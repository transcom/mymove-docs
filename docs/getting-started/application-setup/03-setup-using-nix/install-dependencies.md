...
1. [Set up AWS services](/docs/getting-started/application-setup/01-base-setup/05-aws-services.md)

1. Configure direnv:

   1. [Set up direnv](/docs/getting-started/application-setup/01-base-setup/06-direnv.md)
...
1. Run
   ...
   1. This will install some things like `pre-commit` hooks, `node_modules`, etc. You can see
      [Setup: Dependencies](/docs/getting-started/application-setup/dependencies) for more info on some of the parts.
